...
class MediaCriticism(MultiRESTClient):
    ...
    '''
    CLASSIFIER_WS_BASE_PATH = '/mcmc/rest/'
    ...
    def checkDocumentRelevance(self, classifyRequest):
        result = self.request(self.CLASSIFIER_WS_BASE_PATH + 'checkDocumentRelevance', classifyRequest)
        return result['isRelevantDocument'] , result['mediacriticism'] , result['recognizeEntities']
...
class TestClassifier(unittest.TestCase):
    ...
    def test_submit_classify(self):
        ...
        mc = MediaCriticism()
        result = mc.checkDocumentRelevance(json_classify_data)
        print result         
