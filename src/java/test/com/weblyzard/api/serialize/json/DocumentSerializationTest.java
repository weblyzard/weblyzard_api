...
public class DocumentSerializationTest {
    ...
    public void test() throws IOException {
        final Map<DocumentPartition, List<Span>> partitions = new EnumMap<>(DocumentPartition.class);
        ...
        partitions.put(DocumentPartition.SENTENCE, List.of(
                        new SentenceCharSpan(0, 20).setId(MD5Digest.fromHexDigest("75c3e1e742f17035b3577da2305aae32")),
                        new SentenceCharSpan(21, 51).setId(MD5Digest.fromHexDigest("bce107aa34894c5dbf31c04405a14379")),
                        new SentenceCharSpan(52, 106)
                                        .setId(MD5Digest.fromHexDigest("822a4044672cf761d98441fb565cc930"))));
        ...
        final Document document = new Document().setId("007").setFormat("text/html").setLang(Lang.EN)
                        .setNilsimsa("1404e487721ca21e08c2141155621022f39a991640a419064123b812a30f2acc")
                        .setContent("1 Corinthians 13:4-7\nLove is patient, love is kind. It does not envy, it does not boast, it is\nnot proud.")
