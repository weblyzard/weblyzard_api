...
public class EntityDescriptor {
    ...
    @XmlAttribute(name = "preferred_name", namespace = Document.NS_WEBLYZARD)
    private String preferredName;

    /** This field determines the entity's type (e.g. Person, Organiatzion, etc.) */
    @JsonProperty("entity_type")
    @XmlAttribute(name = "entity_type", namespace = Document.NS_WEBLYZARD, required = false)
    private String entityType;

    /** This field allows adding custom annotations to entities */
    @JsonProperty("entity_metadata")
    @XmlAttribute(name = "entity_metadata", namespace = Document.NS_WEBLYZARD)
