...
public class JosephClient extends BasicClient {
	...
	private static final String LOAD_PROFILE_SERVICE_URL = "/joseph/rest/load_profile/{" + template_profileName + "}";
	private static final String UNLOAD_PROFILE_SERVICE_URL = "/joseph/rest/unload_profile/{" + template_profileName + "}";
	private static final String CLEAN_PROFILE_SERVICE_URL = "joseph/rest/clean/{" + template_profileName + "}";
	private static final String CLASSIFY_SERVICE_URL = "/joseph/rest/classify/{" + template_profileName + "}";
	private static final String TRAIN_SERVICE_URL = "/joseph/rest/train/{" + template_profileName + "}/{" + template_category1 + "}";
	private static final String RETRAIN_SERVICE_URL = "/joseph/rest/retrain/{" + template_profileName + "}/{" + template_category1 + "}";
	private static final String FORGET_SERVICE_URL = "/joseph/rest/forget/{" + template_profileName + "}/{" + template_category1 + "}";
