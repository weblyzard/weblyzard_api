...
public class JesajaClient extends BasicClient {
    ...
    private static final String SET_MATVIEW_PROFILE_URL = "/rest/set_matview_profile/{"
    ...
    public Map<String, Map<String, Double>> getKeywords(String matviewId,
    ...
    public void setKeywordProfile(String profileName, KeywordCalculationProfile keywordProfile) {
        try (Response response = super.getTarget(SET_KEYWORD_PROFILE_URL)
                        .resolveTemplate(TEMPLATE_PROFILE, profileName)
                        .request(MediaType.APPLICATION_JSON_TYPE)
                        .post(Entity.json(keywordProfile))) {
