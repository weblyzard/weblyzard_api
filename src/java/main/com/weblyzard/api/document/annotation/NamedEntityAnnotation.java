...
/**
 * A compact annotation. This is similar to the standard annotation but with
 * extra properties rather than the nested gate features.
 * 
...
@JsonIgnoreProperties({ "sentence", "start", "end", "surfaceForm", "scoreName", "grounded", "pos", "md5sum", "@type" })
...
//	private List<AnnotationSurface> entities;
	 ...
	 * 
	 * @param start
	 *            offset where the token starts
	 * @param end
	 *            offset where the token ends
	 * @param sentenceId
	 * 			  sentence Id
	 * @param confidence
	 *            of the entity matching this token
	 * @param preferredName
	 * 
	 *            identifier of the entity matching this token
	 * @param profile
	 *            where the entity was retrieved from
	 * @param entityType
	 * @param score
	...
	/**
	 * Returns true if both Annotations share at least one character at the
	 * start or end.
	 * 
	 * @param a
	 * @return
