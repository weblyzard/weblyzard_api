...
def test_normalized_namespace():
    ...
    assert NORMALIZED_NAMESPACE[
               "https://www.wikidata.org/wiki/Q42"] == "http://www.wikidata.org/entity/Q42"
    # default replacement of https->http
    assert NORMALIZED_NAMESPACE[
               "https://en.wikipedia.org/wiki/Longyearbyen"] == "http://en.wikipedia.org/wiki/Longyearbyen"
