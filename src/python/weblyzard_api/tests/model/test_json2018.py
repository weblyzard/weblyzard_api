...
from weblyzard_api.model.parsers.json_2018 import JSON2018Parser
...
class TestJSON2018Parser(unittest.TestCase):
    ...
    def test_from_json(self):
        document = JSON2018Parser.from_json(self.JSON_2018)
    ...
    def test_full(self):
        ...
        pprint(result)
        print("=======")
        pprint(self.JSON_2018)
        assert result == self.JSON_2018
