...
class TestRecognizeNg(unittest.TestCase):
    ...
    SERVICE_URL = "http://recognize-ng-wl-rest-api.prod.i.weblyzard.net:8443"
    SERVICE_URL = "http://recognize-ng-en.prod.i.weblyzard.net:8443/"
    ...
    DOCUMENTS = [
        {
            ...
            "partitions": {
                "BODY": [{"@type": "CharSpan", "end": 184, "start": 20}],
                "LINE": [
                    {"@type": "CharSpan", "end": 19, "start": 0},
                    {"@type": "CharSpan", "end": 184, "start": 20},
                ],
                "SENTENCE": [
                    {
                ...
                "TITLE": [{"@type": "CharSpan", "end": 19, "start": 0}],
                "TOKEN": [
                    {
                        "@type": "TokenCharSpan",
                        "dependency": {"label": "null", "parent": -1},
                        "end": 5,
                        "pos": "UH",
                        "start": 0,
                    },
                    {
                        "@type": "TokenCharSpan",
                        "dependency": {"label": "NMOD", "parent": 3},
                        "end": 7,
                        "pos": """,
                                              "start": 6},
                                             {"@type": "TokenCharSpan",
                    ...
                    {
                        "@type": "TokenCharSpan",
                        "dependency": {"label": "SUFFIX", "parent": 3},
                        "end": 18,
                        "pos": "RBR",
                        "start": 14,
                    },
                    ...
                    {
                        "@type": "TokenCharSpan",
                        "dependency": {"label": "NAME", "parent": 2},
                        "end": 32,
                        "pos": "NNP",
                        "start": 27,
                    },
                    ...
                    {
                        "@type": "TokenCharSpan",
                        "dependency": {"label": "COORD", "parent": 2},
                        "end": 43,
                        "pos": "NNP",
                        "start": 37,
                    },
                    {
                        "@type": "TokenCharSpan",
                        "dependency": {"label": "NAME", "parent": 5},
                        "end": 49,
                        "pos": "NNP",
                        "start": 44,
                    },
                    {
                        "@type": "TokenCharSpan",
                        "dependency": {"label": "CONJ", "parent": 3},
                        "end": 53,
                        "pos": "VBP",
                        "start": 50,
                    },
                    {
                        "@type": "TokenCharSpan",
                        "dependency": {"label": "ROOT", "parent": 0},
                        "end": 64,
                        "pos": "NNS",
                        "start": 54,
                    },
                    ...
                    {
                        "@type": "TokenCharSpan",
                        "dependency": {"label": "NMOD", "parent": 11},
                        "end": 78,
                        "pos": "NNP",
                        "start": 72,
                    },
                    ...
                    {
                        "@type": "TokenCharSpan",
                        "dependency": {"label": "PMOD", "parent": 8},
                        "end": 86,
                        "pos": ".",
                        "start": 85,
                    },
                    ...
                    {
                        "@type": "TokenCharSpan",
                        "dependency": {"label": "NMOD", "parent": 4},
                        "end": 108,
                        "pos": "NN",
                        "start": 101,
                    },
                    ...
                    {
                        "@type": "TokenCharSpan",
                        "dependency": {"label": "PMOD", "parent": 5},
                        "end": 120,
                        "pos": ",",
                        "start": 119,
                    },
                    ...
                    {
                        "@type": "TokenCharSpan",
                        "dependency": {"label": "DEP", "parent": 14},
                        "end": 134,
                        "pos": "DT",
                        "start": 131,
                    },
                    ...
                    {
                        "@type": "TokenCharSpan",
                        "dependency": {"label": "PMOD", "parent": 12},
                        "end": 154,
                        "pos": ".",
                        "start": 153,
                    },
                    ...
                    {
                        "@type": "TokenCharSpan",
                        "dependency": {"label": "LOC-PRD", "parent": 3},
                        "end": 178,
                        "pos": "NNP",
                        "start": 171,
                    },
                    {
                        "@type": "TokenCharSpan",
                        "dependency": {"label": "HMOD", "parent": 7},
                        "end": 179,
                        "pos": '"',
                        "start": 178,
                    },
                    {
                        "@type": "TokenCharSpan",
                        "dependency": {"label": "SUFFIX", "parent": 5},
                        "end": 184,
                        "pos": "CD",
                        "start": 180,
                    },
        ...
        for document in self.DOCUMENTS:
            ...
            for url, profile in urls_profiles_mapping:
                ...
                result = client.search_document(
                    profile_name=profile, document=document, limit=0
                )
            ...
            if self.REQUIRED_REGEXPS:
                for regexp in self.REQUIRED_REGEXPS:
                    assert any(
                        re.match(regexp, entity["key"]) for entity in annotations
                    )
...
@pytest.mark.xfail(
    reason="Currently `de_full_all` uses only unique street "
...
class TestRecognizeDisambiguation(TestRecognizeNg):
    ...
    DOCUMENTS = [
        {
            "annotations": [],
            "content": "In der Waidhausenstraße in Wien ist ab dem 25. Januar 2026 eine Baustelle.",
            "format": "text/html",
            "header": {},  #
            "id": "1000",
            "lang": "DE",
...
class TestRecognizeWhiteHouse(TestRecognizeNg):
    ...
    REQUIRED_REGEXPS = [
        re.compile(r"http://www.wikidata.org/entity/Q6279"),
        # Biden
    ...
    DOCUMENTS = [
        {
            "annotations": [],
            "content": "Today, President Biden, at 79, is of advanced age and ostensibly vulnerable to the virus’s worst effects. "
        ...
        for year in range(2017, 2023):
            for countryname, country in {
                ...
                self.DOCUMENTS[0]["header"] = {
                    ...
                    "{http://weblyzard.com/skb/property/}yearUri": f"http://purl.org/dc/terms/date#{year}",
                    "{http://weblyzard.com/skb/property/}location": country,
                }
                self.REQUIRED_REGEXPS = [re.compile(rf".*Easter.*#{year}.*")]
                TestRecognizeNg.test_annotate_document(self)
    ...
    DOCUMENTS = [
        {
            ...
            "lang": "DE",
            "nilsimsa": "00FC4CB928D78CB770521A11DFDE0923DC3C19 E1642274E6AC7C06650B80E6ED",
            "partitions": {"BODY": [{"@type": "CharSpan", "end": 184, "start": 20}]},
        }
    ]
...
class TestRecognizeGeonames(TestRecognizeNg):
    ...
    example4 = "Amazon, Bmw, Audi, Cohere, Porsche,  Anthropic and OpenAI are all AI companies from the US."
    PROFILE_NAME = "en_full_bg"
    DOCUMENTS = [
        {
            "annotations": [],
...
class TestRecognizeGeonamesAU(TestRecognizeNg):
    REQUIRED_REGEXPS = [
        "http://sws.geonames.org/7839347/",  # Broome
...
class TestRecognizeCountries(TestRecognizeNg):
    REQUIRED_REGEXPS = [
        "http://sws.geonames.org/6254930/",  # Palestine
    ]
