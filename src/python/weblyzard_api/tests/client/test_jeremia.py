...
class JeremiaTest(unittest.TestCase):
    DOCS = [{"id": content_id,
             "body": f"Good day Mr. President! Hello \"world\" {content_id}",
    ...
    def test_single_document_with_annotations(self):
        ...
        DOC = {"id": 12,
               ...
               "format": "text/html",
               "title_annotation": [{"start": 0, "end": 3, "surfaceForm": "UBS",
                                     "key": "http://dbpedia.org/UBS"},
                                    {"start": 11, "end": 24,
                                     "surfaceForm": "Credit Suisse",
                                     "key": "http://dbpedia.org/Credit Suisse"}],
               "body_annotation": [{"start": 0, "end": 3, "surfaceForm": "UBS",
                                    "key": "http://dbpedia.org/UBS"},
                                   {"start": 56, "end": 58, "surfaceForm": "CS",
                                    "key": "http://dbpedia.org/Credit Suisse"}],
               "header": {},
               }
    ...
    def test_blacklist(self):
        ...
        sentences = self._get_sentences(
            j.submit_documents(documents=docs, source_id=source_id,
                               wait_time=30)).pop()
        ...
        # no blacklist
        sentences = self._get_sentences(
            j.submit_documents(documents=docs, wait_time=30)).pop()
    ...
    def test_custom_headers(self):
        ...
        assert "<wl:page xmlns:wl=\"http://www.weblyzard.com/wl/2013#\" xmlns:dc=\"http://purl.org/dc/elements/1.1/\" wl:id=\"124\" dc:format=\"text/html\" xml:lang=\"de\" wl:nilsimsa=\"8030473ac029f400680409349e47100e00a29585c04a25ec808342b4c0a1aec8\">".lower() in \
               second[
                   "xml_content"].lower()
