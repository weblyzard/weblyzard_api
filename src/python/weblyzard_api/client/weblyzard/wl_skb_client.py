...
class SkbApiClient(object):
    ...
    def get_entity_by_property(self, property_value, property_name=None,
        ...
        [{u'entityType': u'AgentEntity', 
        u'uri': u'http://weblyzard.com/skb/entity/agent/you_don_t_say', 
        u'last_modified': u'2018-05-17T13:16:24.779019', u'_id': 
        u'agent:you_don_t_say',
        u'properties': {
             u'url': u'youdontsayaac.com', 
             u'publisher': 
             u"You Don't Say", 
             u'locale': 
             u'en_US', 
             ...
             u'preferredName': u"You Don't Say"
        }]
        '''
...
class SKBSentimentDictionary(dict):
    ...
    SENTIMENT_PATH = '{}/skb/sentiment_dict'.format(SkbApiClient.VERSION)
